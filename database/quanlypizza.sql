...
(38, 111, 1, 169000, 169000),
(38, 112, 2, 129000, 258000);
...
(2, 'Giảm 20% đơn hàng từ 150.000đ', 20, 150000, '2025-04-22', '2026-05-22'),
(4, 'Giảm 10% đơn hàng từ 80.000đ', 10, 80000, '2025-04-22', '2026-05-22'),
(6, '30/04-01/05 giảm 30% đơn hàng từ 300.000đ', 30, 300000, '2025-04-20', '2025-05-08');
...
(38, 11, 0, '2025-08-30', 341600, 'Đã thanh toán');
...
(1, 'Nguyễn Văn', 'An', 'Nam', 0, 1),
(2, 'Trần Ngọc', 'Bình', 'Nữ', 0, 1),
(3, 'Lê Thị', 'Giải', 'Nữ', 0, 1),
(4, 'Hà Thanh', 'Thoát', 'Nam', 0, 1),
...
(4, 2, 0, '2025-08-19', 1027000),
(5, 2, 0, '2025-08-23', 268000),
(7, 2, 0, '2025-08-26', 90000),
(8, 2, 0, '2025-07-02', 1070000),
(9, 1, 0, '2025-07-04', 1000000),
(10, 5, 0, '2025-07-07', 11360000);
